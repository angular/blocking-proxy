/**
 * Creates a floating transparent div at the specified location in order to highlight a particular
...
exports.REMOVE_HIGHLIGHT_FN = function() {
  var el = document.getElementById('bpElementHighlight');
  if (el) {
